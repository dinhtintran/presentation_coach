...
export const metadata: Metadata = {
  title: "Sign Up - Presentation Coach",
  description: "Create your Presentation Coach account",
};
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -right-48 w-96 h-96 bg-pink-500/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Link href="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-white font-bold text-2xl">Presentation Coach</span>
        </Link>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Start your journey to better presentations</p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <div className="flex items-start">
              ...
              <label htmlFor="terms" className="ml-2 text-sm text-gray-300">
                I agree to the{" "}
                <Link href="/tos" className="text-purple-400 hover:text-purple-300">
                  Terms of Service
                </Link>{" "}
                and{" "}
            ...
            <Link
              ...
              className="block w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-lg font-semibold text-center hover:shadow-lg hover:shadow-purple-500/50 transition"
            >
              Create Account
            </Link>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-2 px-4 py-3 bg-white/5 border border-white/20 rounded-lg text-white hover:bg-white/10 transition"
              >
